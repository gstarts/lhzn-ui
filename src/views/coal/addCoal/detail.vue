      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="提煤单号" prop="coalNumber">
            <el-input v-model="form.coalNumber" placeholder="请输入提煤单号" disabled/>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="收货单位" prop="receivingUnit">
            <el-input v-model="form.receivingUnit" placeholder="请输入收货单位" disabled/>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="客户" prop="custom">
            <el-input v-model="form.custom" placeholder="请输入客户" disabled/>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="货物名称" prop="variety">
            <el-input v-model="form.variety" placeholder="请输入货物名称" disabled/>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="合同号" prop="contract">
            <el-input v-model="form.contract" placeholder="请输入合同号" disabled/>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="提煤总量" prop="weight">
            <el-input v-model="form.weight" placeholder="请输入提煤量" disabled/>
          </el-form-item>
        </el-col>
        <el-col :span="6">
      ...
      >
        <el-row>
          <el-col :span="6">
            <el-form-item label="承运单位" prop="carryingUnit">
              <el-input v-model="smallform.carryingUnit" placeholder="请输入承运单位" disabled/>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="司机姓名" prop="driver">
              <el-input v-model="smallform.driver" placeholder="请输入司机姓名" disabled/>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="手机号码" prop="phone">
              <el-input v-model="smallform.phone" placeholder="请输入手机号码" disabled/>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="装载地点" prop="loadPlace">
              <el-input v-model="smallform.loadPlace" placeholder="请输入装载地点" disabled/>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="车牌号码" prop="plate">
              <el-input v-model="smallform.plate" placeholder="请输入车牌号码" disabled/>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="驱动桥数目" prop="warehouseId" >
              <el-select v-model="smallform.driveNum" placeholder="请选择类型" clearable disabled>
                <el-option
        ...
        <el-row>
           <el-form-item label="备 注 栏" prop="remarks">
              <el-input v-model="smallform.remarks" placeholder="请 输 入 备 注 栏 " disabled/>
            </el-form-item>
        </el-row>
      </el-form>
    </div>
    ...
    ssubmitForm: function() {
      this.$refs["smallform"].validate(valid => {
        if (valid) {
          ...
          console.log(this.form.coalNumber);
