<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true">
      ...
      <el-form-item label="电子车牌号" prop="No">
        <el-input
    ...
    <div>
      <el-row :gutter="10">
        ...
        <el-col :span="1">
          <el-button size="small" type="primary" v-hasPermi="['monitor:data:artificial']"  @click="handleOperat">人工抬杆</el-button>
        </el-col>
      </el-row>
    </div>
      ...
      <el-tab-pane label="通关中数据" name="dur">
        <el-row>
          <el-table v-loading="loading" :data="durList">
            ...
            <el-table-column label="业务解释" align="center" prop="procErrorDescription"/>
            <el-table-column label="技术解释" align="center" prop="techErrorDescription"/>
            <el-table-column label="进出口标志" align="center" prop="iEFlag" :formatter="IEFormat"/>
    ...
    <el-dialog title="通关异常信息" :visible.sync="open" width="800px">
      <el-row :gutter="5">
        <el-col :span="14">
          <div class="grid-content bg-purple">
            <el-image :src="PhotoName"></el-image>
          </div>
        </el-col>
        <el-col :span="10">
          <div class="grid-content bg-purple">
            ...
            >
              <el-form-item label="通道名称:">
                <el-input v-model="form.chnlName"></el-input>
              </el-form-item>
              ...
              <el-row>
                <el-col :span="6">
                  <el-button
                    v-if="form.checkResult !== 'Y'"
                    type="primary"
                    size="mini"
                    @click="supplementCollection"
                  >补采
                  </el-button>
                </el-col>
                <el-col :span="6">
      ...
      <el-row :gutter="5">
        <el-col :span="24/photoList.length" v-for="item in photoList " :key="item.id">
          <div class="grid-contentt bg-purple rightullidiv" @click="clickImage(item.photoGuid)">
            <el-image lazy :src="item.photoGuid" class="rightulliimg"></el-image>
          </div>
        </el-col>
      </el-row>
    </el-dialog>
    ...
    <el-dialog title="通关放行信息" :visible.sync="openSupplementary" width="380px">
      ...
      >
        ...
        <el-form-item label="进出类型:" prop="iEFlag">
          <!-- <el-input v-model="form.iEFlag"></el-input> -->
        ...
        <el-form-item label="车牌号:" prop="veLicenseNo">
          <el-input v-model="smallForm.veLicenseNo"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listData(this.addDateRange(this.queryParams, this.dateRange)).then(
        response => {
          ...
          this.arrTotal.push(response.data.dur.total)
          this.arrTotal.push(response.data.list.total)
          this.arrTotal.push(response.data.err.total)
          this.loading = false
        }
      )
    },
    ...
    handleClick(tab, event) {
      if (tab.name === 'dur') {
        this.total = this.arrTotal[0]
        this.activeName = 'dur'
      }
      if (tab.name === 'list') {
        this.total = this.arrTotal[1]
        this.activeName = 'list'
      }
      if (tab.name === 'err') {
        this.total = this.arrTotal[2]
        this.activeName = 'err'
      }
    },
    /** 补采按钮 */
