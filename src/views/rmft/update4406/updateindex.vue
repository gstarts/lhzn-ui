...
<script>
import { listHead, getHead, delHead, addHead, updateHead, exportHead ,getTransport,getCoal,getTransportDetail,getCoalDetail, updateTransportInfor,updateCoalInfor} from "@/api/report/head";
